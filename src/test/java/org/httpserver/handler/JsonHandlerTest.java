...
class JsonHandlerTest {
    ...
    @Test
    void returnsResponse_withStatusLineAndBody_withJson() throws JsonProcessingException {
        ...
        assertEquals("{\"key1\":\"value1\",\"key2\":\"value2\"}", new String(actualResponse.getBodyBytes()));
    }
}
