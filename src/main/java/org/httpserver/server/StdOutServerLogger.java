...
public class StdOutServerLogger implements ServerLogger {
    ...
    public void printNumberOfClientsConnected(int clientConnectionCounter){System.out.println("Number of clients connected: "+ clientConnectionCounter);}
    ...
    public void printClosedClientConnection(int clientPortNumber){ System.out.println("[+] Client request reader, response writer & socket closed on port number: " + clientPortNumber);}
